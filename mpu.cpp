...
//}
//
//void read_n_registers(uint8_t adress, uint8_t data[], int amount){
//    hwlib::i2c_write_transaction(i2c_bus, CHIP_ID).write(adress);
//    hwlib::i2c_read_transaction transaction(i2c_bus, CHIP_ID);
//    data[0] = transaction.read_byte();
//    for(int i = 1; i < amount; i++){
//        data[i] = transaction.read_byte();
//    }
//}
...
//void mpu6000_spi::write_register(uint8_t adress, uint8_t data){
//    spi_bus.transaction(csn).write_byte(adress).write_byte(data);
//}
//    
//uint8_t mpu6000_spi::read_register(uint8_t adress){
//    return spi_bus.transaction(csn).write_byte(adress).read_byte();
//}
//    
//void mpu6000_spi::read_n_registers(uint8_t adress, uint8_t data[], int amount){
//    spi_bus.transaction(csn).write_byte(adress).write_read(amount, nullptr, data);
//}
//    
//void mpu6000_spi::enable_spi(){
//    hwlib::i2c_write_transaction(i2c_bus, CHIP_ID).write(USER_CTRL);
//    uint8_t read = hwlib::i2c_read_transaction(i2c_bus, CHIP_ID).read_byte();
//    read = read | 0b00010000;
//    hwlib::i2c_write_transaction transaction(i2c_bus, CHIP_ID);
//    transaction.write(USER_CTRL);
